...
type Props = NativeStackNavigationProp<ProfileParamalist, 'PivacyPolicy'>;
...
export default function PrivacyPolicyScreen() {
    ...
    const htmlContent = data?.['privacyPolicy'] ?? '';
    ...
    return (
        ...
        >
            <AppHeader title="Privacy Policy" onPress={() => navigation.goBack()} />
