      ...
      <ScrollView
        ...
        <View className=" gap-2">
          ...
          <TouchableOpacity
            ...
            <Text className="flex-1 text-lg text-white">Following</Text>
          ...
          <TouchableOpacity
            ...
            className="flex-row items-center gap-4 rounded-2xl bg-white/20 p-2 pr-4">
            <NotificationIcon height={40} width={40} />
            <Text className="flex-1 text-lg text-white">saved</Text>
            <ArrowIcon height={24} width={24} />
          </TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            className="flex-row items-center gap-4 rounded-2xl bg-white/20 p-2 pr-4">
            <NotificationIcon height={40} width={40} />
            <Text className="flex-1 text-lg text-white">Downloads</Text>
            <ArrowIcon height={24} width={24} />
          </TouchableOpacity>
