...
import {
  ActivityIndicator, KeyboardAvoidingView, Modal, Platform, ScrollView, Text,
...
import { getCommentStats, getCommentUserReaction, getVideoComments, postComment } from '@/domain/video/api/shortComments.service';
import ReplyModal from './ShortReplyModal';
...
export default function ShortCommentsModal({
  visible,
  onClose,
  videoId,
  targetType = 'Video',
