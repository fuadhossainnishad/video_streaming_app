...
export default function VideoPlayer({
    ...
    return (
        <View style={{ height: videoHeight, width: isFullscreen ? height : width }} className="bg-black">
            <Video
                ref={videoRef}
                source={{ uri }}
            ...
            {(showControls || !isPlaying) && (
                <View className="absolute inset-0 flex-row items-center justify-center gap-12 w-full">
                    ...
                    >
                        ...
                        <Text className="text-white text-[9px] font-bold absolute -bottom-0.5">10</Text>
                    </TouchableOpacity>
