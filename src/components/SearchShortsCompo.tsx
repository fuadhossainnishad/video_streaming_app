...
import { searchShorts, } from '@/domain/video/api/search.service';
import { ShortData } from '@/shared/types/shorts.types';
import ShortsModal from './ShortsModal';

export default function SearchShortsCardComponent({ query, vertical = false }: { query: string, vertical?: boolean }) {
