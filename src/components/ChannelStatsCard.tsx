...
import { View, Text, Image, StyleSheet, TouchableOpacity, ActivityIndicator, RefreshControl } from 'react-native';
...
export default function ChannelStatsCard() {
    ...
    const renderContent = () => {
        ...
        return (
            <LinearGradient
                colors={['#AEFF001A', '#000000']}
                style={styles.container}>
                <View style={styles.header}>
                    {/* Channel Icon */}
                    <View style={styles.iconContainer}>
                        <Image
                            source={{ uri: stats.avatar }}
                    ...
                    <View style={styles.infoContainer}>
                        ...
                        <View style={styles.statsGrid}>
                            ...
                            <View style={styles.statRow}>
                                ...
                                <Text style={styles.statValue}>
                                    {formatHours(stats.totalWatchTime)}
                                </Text>
                            </View>
                        </View>
                    </View>
