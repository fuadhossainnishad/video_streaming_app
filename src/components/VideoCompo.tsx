...
import { View, TouchableOpacity, Text, ActivityIndicator, ScrollView, RefreshControl, StyleSheet } from 'react-native';
import VideoRender from './VideoRender';
import { VideoData } from '@/shared/types/video.types';
import { useNavigation } from '@react-navigation/native';


export default function VideoCardComponent({ vertical = false }: { vertical?: boolean }) {
